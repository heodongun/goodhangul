...
// src/disassembleCompleteCharacter.ts
...
function hasBatchim(str, options) {
  ...
  if ((options == null ? void 0 : options.only) === "single") {
    return JONGSEONGS[batchimCode].length === 1;
  }
  if ((options == null ? void 0 : options.only) === "double") {
    return JONGSEONGS[batchimCode].length === 2;
  }
  return batchimCode > 0;
}

// src/removeLastCharacter.ts
...
// src/convertQwertyToAlphabet.ts
...
function josaPicker(word, josa2) {
  ...
  let index = has\uBC1B\uCE68 ? 0 : 1;
  const is\uC885\uC131\u3139 = ((_a = disassembleCompleteCharacter(word[word.length - 1])) == null ? void 0 : _a.jongseong) === "\u3139";
...
// src/standardizePronunciation/standardizePronunciation.constants.ts
var \uC74C\uAC00\uAC00_\uC5C6\uB294_\uC790\uC74C = "\u3147";
...
// src/standardizePronunciation/index.ts
