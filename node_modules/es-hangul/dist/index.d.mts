 ...
 */
declare function assemble(words: string[]): string;
 ...
 * 중성으로 올 수 있는 한글 글자
 */
declare const JUNSEONGS: ("ㅏ" | "ㅐ" | "ㅑ" | "ㅒ" | "ㅓ" | "ㅔ" | "ㅕ" | "ㅖ" | "ㅗ" | "ㅗㅏ" | "ㅗㅐ" | "ㅗㅣ" | "ㅛ" | "ㅜ" | "ㅜㅓ" | "ㅜㅔ" | "ㅜㅣ" | "ㅠ" | "ㅡ" | "ㅡㅣ" | "ㅣ")[];
/**
 * 종성으로 올 수 있는 한글 글자
 */
 ...
 */
declare function canBeJungseong(character: string): character is (typeof JUNSEONGS)[number];
/**
 * @name canBeJongseong
 * @description
